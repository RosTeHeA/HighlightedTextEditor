...
#if os(macOS)
let codeFont = NSFont(name: "Lato-Regular", size: 16.0) ?? NSFont.systemFont(ofSize: 16.0)
...
#else
let codeFont = UIFont(name: "Lato-Regular", size: 16.0) ?? UIFont.systemFont(ofSize: 16.0)
